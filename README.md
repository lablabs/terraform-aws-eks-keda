...
| <a name="input_metric_server_irsa_additional_policies"></a> [metric\_server\_irsa\_additional\_policies](#input\_metric\_server\_irsa\_additional\_policies) | Map of the additional policies to be attached to default role of the KEDA metrics server. Where key is arbitrary id and value is policy ARN. | `map(string)` |
| <a name="input_metric_server_irsa_assume_role_arns"></a> [metric\_server\_irsa\_assume\_role\_arns](#input\_metric\_server\_irsa\_assume\_role\_arns) | Assume role ARNs for the KEDA metrics server. Applied only if `metric_server_irsa_assume_role_enabled` is `true`. | `list(string)` |
| <a name="input_metric_server_irsa_assume_role_enabled"></a> [metric\_server\_irsa\_assume\_role\_enabled](#input\_metric\_server\_irsa\_assume\_role\_enabled) | Whether IRSA for the KEDA metrics server is allowed to assume role defined by `metric_server_irsa_assume_role_arn`. Mutually exclusive with `metric_server_irsa_policy_enabled`. | `bool` |
| <a name="input_metric_server_irsa_permissions_boundary"></a> [metric\_server\_irsa\_permissions\_boundary](#input\_metric\_server\_irsa\_permissions\_boundary) | ARN of the policy that is used to set the permissions boundary for the IRSA role of the KEDA metrics server. Defaults to `""`. | `string` |
...
| <a name="input_operator_irsa_additional_policies"></a> [operator\_irsa\_additional\_policies](#input\_operator\_irsa\_additional\_policies) | Map of the additional policies to be attached to default role of the KEDA operator. Where key is arbitrary id and value is policy ARN. | `map(string)` |
| <a name="input_operator_irsa_assume_role_arns"></a> [operator\_irsa\_assume\_role\_arns](#input\_operator\_irsa\_assume\_role\_arns) | Assume role ARNs for the KEDA operator. Applied only if `operator_irsa_assume_role_enabled` is `true`. | `list(string)` |
| <a name="input_operator_irsa_assume_role_enabled"></a> [operator\_irsa\_assume\_role\_enabled](#input\_operator\_irsa\_assume\_role\_enabled) | Whether IRSA for the KEDA operator is allowed to assume role defined by `operator_irsa_assume_role_arn`. Mutually exclusive with `operator_irsa_policy_enabled`. | `bool` |
| <a name="input_operator_irsa_permissions_boundary"></a> [operator\_irsa\_permissions\_boundary](#input\_operator\_irsa\_permissions\_boundary) | ARN of the policy that is used to set the permissions boundary for the IRSA role of the KEDA operator. Defaults to `""`. | `string` |
...
| <a name="input_webhooks_irsa_additional_policies"></a> [webhooks\_irsa\_additional\_policies](#input\_webhooks\_irsa\_additional\_policies) | Map of the additional policies to be attached to default role of the KEDA webhooks. Where key is arbitrary id and value is policy ARN. | `map(string)` |
| <a name="input_webhooks_irsa_assume_role_arns"></a> [webhooks\_irsa\_assume\_role\_arns](#input\_webhooks\_irsa\_assume\_role\_arns) | Assume role ARNs for the KEDA webhooks. Applied only if `webhooks_irsa_assume_role_enabled` is `true`. | `list(string)` |
| <a name="input_webhooks_irsa_assume_role_enabled"></a> [webhooks\_irsa\_assume\_role\_enabled](#input\_webhooks\_irsa\_assume\_role\_enabled) | Whether IRSA for the KEDA webhooks is allowed to assume role defined by `webhooks_irsa_assume_role_arn`. Mutually exclusive with `webhooks_irsa_policy_enabled`. | `bool` |
| <a name="input_webhooks_irsa_permissions_boundary"></a> [webhooks\_irsa\_permissions\_boundary](#input\_webhooks\_irsa\_permissions\_boundary) | ARN of the policy that is used to set the permissions boundary for the IRSA role of the KEDA webhooks. Defaults to `""`. | `string` |
